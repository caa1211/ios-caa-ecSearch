...
// OHMKit
#define COCOAPODS_POD_AVAILABLE_OHMKit
#define COCOAPODS_VERSION_MAJOR_OHMKit 0
#define COCOAPODS_VERSION_MINOR_OHMKit 2
#define COCOAPODS_VERSION_PATCH_OHMKit 0
